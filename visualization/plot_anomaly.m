function plot_anomaly(dsValue_anom_map, time_bound, year_start, flag_land, ...
    ...
    sgtitle([i_mth_txt ' differences in mean PCR-downscaled ' name_var], 'FontSize', 18, 'FontWeight', 'bold');
