...
if ~isempty(save_name)
    f = figure('Name', save_name, 'Position', [100 100 1000 200]);
end
...
% fix view options
setm(gca,'fontsize',20,'fontweight','bold','glinewidth',1);
set(gca,'FontWeight','bold','FontSize',20,'Tickdir','out','linewidth',1.5,'box','on')
