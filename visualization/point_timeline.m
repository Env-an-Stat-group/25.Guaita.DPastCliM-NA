...
year_end = 2014;
n_min_yr = 150; % minimum number of years for stations
...
list_plotstations = metaTable.ID;%{'USC00190736','USW00014735'};

% Loop over points
for i_station = 1:length(list_plotstations)
    ID_stat = list_plotstations{i_station};    
    ...
    plot_downscaled_timeline_point(name_var, unit_var, time_ESM, time_obs_tmp, obs_value_tmp, ESM_tmp, ...
        dsVal_tmp, dsPIinf_tmp, dsPIsup_tmp, path_fig, suffix_region, name_model, res_plot)
end