...
switch name_var
    case 'pr'
        list_point = {'MXMLP076458', 'USC00049866', 'USC00252205', 'USC00353827', ...
            'USC00354670', 'USC00456096', 'USC00456624', 'USC00456678', 'USW00023185', ...
            'USW00024144', 'USC00043747', 'USC00046506', 'USC00049866', 'USC0072730',...
            'USC00049699','USC00080478','USC00096335','USC00106542','USC00176430',...
            'USC00200032','USC00200230'};
    case 'tas'
        list_point = {'CA001100120', 'CA001163780', 'USC00026796', 'USC00036506', ...
...
for i_station = 1:length(list_point)
    ...
    plot_downscaled_timeline_point(name_var, unit_var, time_ESM, time_obs_tmp, ...
        obs_value_tmp, ESM_tmp, dsVal_tmp, dsPIinf_tmp, dsPIsup_tmp, ...
        path_fig, suffix_region, name_model, res_plot, [1945 50])
